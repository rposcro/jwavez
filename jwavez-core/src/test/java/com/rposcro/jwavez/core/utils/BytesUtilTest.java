...
public class BytesUtilTest {
    ...
    public void testAsConciseString(byte[] bytes, String expected) {
        String actual = BytesUtil.asConciseString(bytes);
        assertEquals(expected, actual);
    }
